...
<%@page import="crm.irfan.DAOFunctions"%>
...
<div class="container" ng-controller="MamulStokEkleCtrl">
	<div class="row">
	...
	<div class="row">
		<form class="form-inline" role="form" method="post" name="mamulstokform" id="mamulstokform" action="mamulstok">
		<div class="col-xs-5">
			...
			<div class="form-group" style="margin-top:5px;">
				<div>
					<button type="button" class="btn btn-danger" ng-click="saveMamulStok()">Ekle</button>
		...
		<div class="col-xs-7" style="font-size:12px;">
			...
			<tr>
				...
				<th><label class="text-danger"><%= UtilFunctions.getTarihTR(new java.util.Date()) %> </label></th>
			</tr>
			<tr>
				<th>Ürün Tanımı</th>
				<th colspan="2" class="text-center"><label class="text-danger"><%= stok.get(0).getBilesenad() %></label></th>
				<th>Envanter Miktarı</th>
				<th><label class="text-danger"><%=sumagg %></label></th>
			</tr>
			<tr>
			...
			for (Stok s : stok) {
				...
				out.println("<tr>");
				out.println("<td>"+ UtilFunctions.getTarihTR((s.getIslemyonu()==1)?s.getCikistarihi():s.getGiristarihi()) +"</td>");
